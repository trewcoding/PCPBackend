...
namespace ServiceLayer.DetailsService
{
    public class ProductServices : IProductService
    {
        ...
        /// <returns>idk</returns>
        public async Task SaveProductAsync(string productId, string bank)
        {
        ...
        public async Task<List<string>> SaveProductsExternalCall(string bank)
        {
            ...
            var newOrUpdatedProducts = await _productsPassThrough.SaveProductsPassThrough(mappedResult);
