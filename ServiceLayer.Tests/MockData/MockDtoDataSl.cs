...
namespace ServiceLayer.UnitTests.MockData
{
    public class MockDtoDataSl
    {
        ...
        public static ProductResponseApiSl productResponseApiSl()
        {
            ProductConstraintSl productConstraintSl = new ProductConstraintSl()
            {
                ConstraintId = Guid.Empty,
            ...
            return productResponseApiSl;
        }
        public static ProductsResponseApiSl listProductsSl()
        {
            ...
            ProductsResponseApiSl productsResponseApiSl = new ProductsResponseApiSl
            {
                Data = new DataSl()
                {
                    Products = new List<ProductsSl>() { productsSl }
                }
            };
            return productsResponseApiSl;
        }
        public static List<ProductsSl> getListProductsSl()
        {
            ProductsSl productsSl = new ProductsSl
            {
                ProductId = "ProductId1",
            ...
            List<ProductsSl> productsSls = new List<ProductsSl>() { productsSl };
            return productsSls;
        }
    }
}
